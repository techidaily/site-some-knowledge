---
title: "Modern Mac Revitalization: Supercharge with the Fedora Asahi Remix of Linux"
date: 2024-08-30T09:04:16.441Z
updated: 2024-08-31T09:04:16.441Z
tags:
  - desktop
categories:
  - tech
...
## Modern Mac Revitalization: Supercharge with the Fedora Asahi Remix of Linux
...
The Asahi Linux project has been hard at work over the past few years, building a usable desktop Linux experience for Mac computers with Apple Silicon (M1, M2, etc.) chipsets. Fedora Asahi Remix is now available, and it's the best option yet for running native Linux on modern Macs.
 ...
 Fedora Asahi Remix currently works on M1 and M2 Macs (no [M3 hardware](https://screen-sharing-recording.techidaily.com/updated-obs-clash-livestream-prodigies-for-2024/) yet), with support for displays, keyboards (including backlights), trackpads, headphone jacks, speakers, cameras, MagSafe charging (only on M2 Macs), USB 3.0 Type-C ocnnections, Wi-Fi, and Bluetooth. There is currently no support for external USB Type-C displays, Thunderbolt and USB 4.0, built-in microphones, or Touch ID.

 Asahi Linux still isn't as feature-complete as macOS on the same computers, or 64-bit x86 Linux on Intel Macs and traditional PCs, but it is an impressive effort (and certainly better than nothing). If you want to see the project continue improving, consider [donating to help cover development costs](https://asahilinux.org/support/).

 You can install Fedora Asahi Linux from the [official download page](https://asahilinux.org/fedora/). You can also run Linux software on top of macOS with applications like [Parallels Desktop](https://screen-mirror.techidaily.com/in-2024-how-to-cast-oneplus-11r-screen-to-pc-using-wifi-drfone-by-drfone-android/), [VMWare Fusion](https://graphic-issues.techidaily.com/accessing-hidden-screen-settings-in-nvidia/), and [Docker Desktop](https://docs.docker.com/desktop/install/mac-install/).
