---
title: "Reorienting Your Computer Display: A Step-by-Step Guide to Correcting Screen Orientation Issues"
date: 2024-08-26 19:40:19
updated: 2024-08-29 10:39:45
tags:
  - deals
categories:
  - tech
...
## Reorienting Your Computer Display: A Step-by-Step Guide to Correcting Screen Orientation Issues

### Quick Links

* [How to Rotate Screen on Windows 10](https://buynow-help.techidaily.com/panasonic-fz80-a-versatile-budget-friendly-pro/)
* [How to Rotate Your Screen With Hotkeys](https://screen-video-capture.techidaily.com/updated-2024-approved-precision-and-power-choosing-best-kung-fu-games-ranked/)
* [How to Disable Automatic Screen Rotation on Windows 10](https://review-topics.techidaily.com/in-2024-fixing-foneazy-mockgo-not-working-on-tecno-pova-5-drfone-by-drfone-virtual-android/)
* [How to Rotate Screen With Your Graphics Drivers](https://techtrends.techidaily.com/the-greenness-dilemma-assessing-the-ecological-footprint-of-electric-vehicles/)

### Key Takeaways

 Rotate the screen on any Windows PC by going to Settings > Display and then changing the orientation. There are usually special controls to rotate your screen provided by your graphics drivers, too.
...
![Right-click empty space and select "Display Settings."](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2023/11/riht-click-display-settings.png) 
...
![Select the "Display Resolution" drop-down box.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2023/11/display-landscape.png) 
...
![Click on the notification icon on the far-right corner of the task bar.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2018/06/img_5b2c2c37868fd.png) 
...
##  How to Rotate Screen With Your Graphics Drivers
 ...
 On PCs with Intel graphics, launch the Intel Command Center from the Start Menu, or by clicking the small blue icon on the Task Bar. Select the Display tab, which is the small monitor icon, and choose a display orientation. This option wasn't available on one of our PCs with Intel graphics, so we had to use the standard Windows Settings app instead. It will only be present here on some PCs.

 Older computers with Intel Graphics will need to use the Intel Control Panel instead of the Command Center. It can be launched by right-clicking empty space on the desktop and clicking "Intel Graphics Settings," or something similar.
...
![Select "Rotate Display," then choose orientation.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2023/11/nvidia.png) 
 ...
 If you're going to put a monitor in portrait mode, make sure you get one that has a stand that allows it to rotate.
